extends ProductRecipe
class_name BodyArmorRecipe
...
func setup_component_slots() -> void:
	...
	var body_component = BodyArmorComponentRecipe.new()
	
	match body_armor_type:
		BodyArmorType.TORSO_ARMOR:
			body_component.body_armor_type = BodyArmorComponentRecipe.BodyArmorType.TORSO_ARMOR
		# BodyArmorType.CHAINMAIL:
			# body_component.body_armor_type = BodyArmorComponentRecipe.BodyArmorType.CHAINMAIL
		BodyArmorType.ARMS_ARMOR:
			body_component.body_armor_type = BodyArmorComponentRecipe.BodyArmorType.ARMS_ARMOR
		BodyArmorType.LEGS_ARMOR:
			body_component.body_armor_type = BodyArmorComponentRecipe.BodyArmorType.LEGS_ARMOR
	...
	var liner_component = BodyArmorComponentRecipe.new()
	
	match body_armor_type:
		BodyArmorType.TORSO_ARMOR:
			liner_component.body_armor_type = BodyArmorComponentRecipe.BodyArmorType.BODY_LINER
		BodyArmorType.ARMS_ARMOR, BodyArmorType.LEGS_ARMOR:
			liner_component.body_armor_type = BodyArmorComponentRecipe.BodyArmorType.LIMB_LINER
		_:
			liner_component.body_armor_type = BodyArmorComponentRecipe.BodyArmorType.BODY_LINER
