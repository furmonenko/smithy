...
func setup_component_slots() -> void:
	...
	var dome_component = HeadArmorComponentRecipe.new()
	dome_component.head_armor_type = HeadArmorComponentRecipe.HeadArmorType.DOME
	...
	if head_armor_type == HeadArmorType.WITH_VISOR:
		...
		var visor_component = HeadArmorComponentRecipe.new()
		visor_component.head_armor_type = HeadArmorComponentRecipe.HeadArmorType.VISOR
	...
	var liner_component = HeadArmorComponentRecipe.new()
	liner_component.head_armor_type = HeadArmorComponentRecipe.HeadArmorType.HEAD_LINER
